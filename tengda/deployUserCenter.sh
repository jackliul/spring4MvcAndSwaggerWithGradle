...
gradle build -x test && cd /cygdrive/d/openCodes/spring4MvcAndSwaggerWithGradle && gradle clean deployUserCenter  -DrealHost='47.89.10.238' -DrealPassword='FararFDe999()'